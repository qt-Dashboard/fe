    ...
    L.Routing.GraphHopper = L.Evented.extend({
        ...
        _convertInstructions: function(instructions) {
            ...
            for (i = 0; instructions && i < instructions.length; i++) {
                ...
                var instructionsTxt = instr.text;
                instructionsTxt = instructionsTxt.replace('Continue onto','Continuez sur');
                instructionsTxt = instructionsTxt.replace('Turn sharp left onto','Tournez à gauche sur');
                instructionsTxt = instructionsTxt.replace('Turn sharp right onto','Tournez à droite sur');
                instructionsTxt = instructionsTxt.replace('Turn slight left onto','Tournez à gauche sur');
                instructionsTxt = instructionsTxt.replace('Turn slight right onto','Tournez à droite sur');
                instructionsTxt = instructionsTxt.replace('Turn left onto','Tournez à gauche sur');
                instructionsTxt = instructionsTxt.replace('Turn right onto','Tournez à droite sur');
                instructionsTxt = instructionsTxt.replace('Turn sharp left','Tournez à gauche sur');
                instructionsTxt = instructionsTxt.replace('Turn sharp right','Tournez à droite sur');
                instructionsTxt = instructionsTxt.replace('Turn slight left','Tournez à gauche sur');
                instructionsTxt = instructionsTxt.replace('Turn slight right','Tournez à droite sur');

                
                instructionsTxt = instructionsTxt.replace('Arrive at','Arrivée à');
                instructionsTxt = instructionsTxt.replace('Turn left','Tournez à gauche');
                instructionsTxt = instructionsTxt.replace('Turn right','Tournez à droite');
                instructionsTxt = instructionsTxt.replace('Keep left','Restez à gauche');
                instructionsTxt = instructionsTxt.replace('Keep right','Restez à droite');
                instructionsTxt = instructionsTxt.replace('At roundabout, take exit','Au rond-point, prenez la sortie');
                instructionsTxt = instructionsTxt.replace('onto','sur');
